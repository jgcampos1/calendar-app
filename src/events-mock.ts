...
export const eventsMock: Event[] = [
  {
    ...
    end_date: add(startOfToday(), { hours: 13, minutes: 15 }),
    title: "First",
  },
  {
    id: "2",
  ...
  // {
  //   id: "9",
  //   start_date: add(startOfToday(), { days: 1, hours: 5 }),
  //   end_date: add(startOfToday(), { days: 1, hours: 7, minutes: 30 }),
  //   title: "Tomorrow event 1",
  // },

  {
    id: "0.4246485164252993",
    start_date: add(startOfToday(), { days: 1, hours: 3 }),
    end_date: add(startOfToday(), { days: 1, hours: 8, minutes: 30 }),
    title: "Novo Evento - 03:30 AM",
  },
  {
    id: "10",
...

  {
    ...
    end_date: add(startOfToday(), { days: 1, hours: 6, minutes: 45 }),
